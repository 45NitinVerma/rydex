					...
					>
						...
						>
							...
							<div className="flex gap-3 mt-6">
								<button
									className="flex-1 py-2 rounded-xl border hover:bg-red-50 text-red-600 font-semibold hover:text-red-700 transition cursor-pointer"
								...
								<button
									...
									className="flex-1 flex items-center justify-center py-2 rounded-xl bg-black text-white transition hover:opacity-90 cursor-pointer"
								>
									{approveLoading ? (
										<>
