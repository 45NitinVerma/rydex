									...
									<div className="flex flex-col justify-between lg:items-end gap-6 w-full lg:w-auto">
										...
										<div className="flex gap-4 w-full lg:w-auto">
											<button
												...
												className="flex-1 lg:flex-none px-6 py-3 rounded-xl border border-gray-700 text-sm font-semibold hover:bg-gray-100 transition-all duration-200 active:scale-[0.98] disabled:opacity-50"
											>
												Reject
											</button>
											<button
