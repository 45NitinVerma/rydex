...
function page() {
	...
	const getStatusColor = (status: string) => {
		const colors: Record<string, string> = {
			confirmed: "bg-emrald-50 text-emrald-700 border-emerald-200",
										...
										<div className="flex items-center gap-3 p-4 bg-linear-to-r from-blue-50 to-indigo-50 border-b border-gray-20">
											...
											<div className="flex-1">
												<div className="flex items-center justify-between">
													...
													<span
														className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(booking.bookingStatus)}`}
													>
										...
										<div className="px-4 pt-3">
											<div className="bg-gray-50 rounded-lg p-2 flex items-center gap-2">
												...
												<div className="text-xs text-gray-600">
													{booking.vehicle.vehicleModel.toUpperCase()}{" "}
													•{" "}
											...
											{(booking.bookingStatus ===
												...
												<div className="flex items-center gap-2">
													<button
														onClick={() =>
															router.push(
																`/user/ride/${booking._id}`,
															)
														}
														className="flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-70 bg-blue-50 hover:bg-blue-100 px-4 py-1.5 rounded-lg transition-colors"
													>
														<span>Details</span>
