...
function ActionCard({ icon, title, button, onClick }: any) {
	return (
		<div className="bg-white rounded-2xl md:rounded-3x; p-5 sm:p-6 md:p-8 shadow-lg border flex flex-col sm:flex-row justify-between items-start sm:items-cetner gap-5">
