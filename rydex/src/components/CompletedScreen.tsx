...
import { CheckCircle, IndianRupee, User } from "lucide-react";
                    ...
                    {booking.user && (
                        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-center gap-3 mb-3">
                            ...
                            <div>
                                ...
                                <p className="text-white text-sm font-bold">{booking?.user?.name}</p>
                            </div>
                        </div>
                    )}

                    <button onClick={()=>router.push("/")} className="w-full border border-zinc-700 text-zinc-400 py-3.5 rounded-2xl text-xm font-semibold hover:bg-zinc-900 transition-colors">
                        Back To Home
                    </button>
