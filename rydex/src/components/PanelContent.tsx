...
const getVehicleIcon = (vehicleType?: string) => {
	switch (vehicleType?.toLowerCase()) {
		...
		case "truck":
			return <Truck size={18} className="w-4 h-4 text-white" />;
		case "loading":
			return <Truck size={18} className="w-4 h-4 text-white" />;
		default:
			return <Car size={18} className="w-4 h-4 text-white" />;
		...
		<div className="flex flex-col pt-5 pb-4 gap-3">
			{isActive && (
				<div className="mx-5 lg:mx-6 grid grid-cols-2 gap-2">
					<div className="bg-zinc-50 border border-zinc-100 rounded-2xl p-4 flex items-center gap-3">
						<div className="w-9 h-9 rounded-xl flex items-center justify-center bg-zinc-100 flex-shrink-0">
			...
			{booking?.vehicle && (
				<div className="mx-5 lg:mx-6">
					<div className="bg-zinc-50 border border-zinc-100 ruonded-2xl p-4 flex items-center gap-3">
