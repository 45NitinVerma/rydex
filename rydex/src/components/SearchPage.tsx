		...
		<div className="min-h-screen bg-zinc-100 text-zinc-900 overflow-x-hidden">
			...
			>
				<div className="px-5 lg:px-8 max-w-6xl mx-auto">
					...
					>
						<div className="flex gap-3 px-4 py-3 border-b border-zinc-300">
							...
							<MapPin
								size={14}
								className="text-zinc-400 mt-1.5 flex-shrink-0"
							/>
						</div>
						<div className="flex gap-3 px-4 py-3 border-b border-zinc-300">
							<div className="flex flex-col items-center pt-1.5 flex-shrink-0">
						...
						<AnimatePresence mode="wait">
							{loading ? (
								<motion.div
									...
									className="flex item-center gap-2 bg-zinc-100 border border-zinc-200 px-3 py-1.5 rounded-full"
								>
					...
					<AnimatePresence>
							{!loading && vehicles.length === 0 && (
								...
								>
									...
									>
										<RefreshCcw size={15} /> Retry Search
									</motion.button>
						...
						<div className="grid grid-col-1 sm:grid-col-2 lg:grid-col-3 xl:grid-cols-4 gap-4">
							{vehicles.map((v, i)=>(
								<motion.div
								key={i}
