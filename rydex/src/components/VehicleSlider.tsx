...
const VehicleSlider = () => {
	...
	return (
		<div className="w-full bg-whtie py-20 px-4 overflow-hidden">
			<div className="max-w-7xl mx-auto">
				...
				>
					<div>
						...
						<h2 className="text-3xl sm:text-4xl font-black tracking-tight text-sinc-900 leading-none">
							Vehicles <br />
								...
								>
									...
									>
										...
										<motion.h3
											...
											transition={{ duration: 0.2 }}
											className="text-lg font-black tracking-tight leadding-none mb-2"
										>
											{c.title}
										</motion.h3>
